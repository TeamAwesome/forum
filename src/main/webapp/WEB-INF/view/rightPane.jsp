...
<div id="rightPane" align="center">
            ...
            <div id='fb-root'>
                ...
                <a href="https://twitter.com/share" data-url="http://10.10.5.107:8080/forum/" data-text="Need info on Bangalore?" data-size="large" data-count="none" target="_blank"><img src="<c:url value='static/images/twitter.png'/>" alt="Twitter"></a>
                </p>
            </div>
</div>
