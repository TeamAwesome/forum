function PlotGraphs (){
	...
	this.setQuestionsGraphFor3Months = function (numQuestionsMon1, numQuestionsMon2, numQuestionsMon3, lenTime){
	...
	this.plot = function(){
		 ...
		 $("#chartdiv2").jqplot('chartdiv2', [[[80, 10],[50,5],[70,10]]],{title: 'Number of Answers',axesDefaults: {
																						   tickRenderer: $.jqplot.CanvasAxisTickRenderer ,
																						   tickOptions: {
																						   angle: -60,
																						   fontSize: '10pt'
